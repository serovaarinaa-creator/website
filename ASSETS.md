...
**Safari тормозит там, где видео ещё и обрезается или блюрится поверх.**
Chrome сам решает, когда пересчитывать такие эффекты, и обычно кэширует
результат, а Safari честно пересобирает кадр видео под скруглением/блюром
на каждый тик. Сильнее всего это било по плашкам с блюрными чипами
(«Мастерская», DoggyMoggy — видео на всю плашку, а чип поверх него
стеклянный) и по блоку «Обо мне» (два видео сразу, одно из них в круглой
маске). Лечится вынесением видео и блюра в свой composite-слой —
`transform: translateZ(0)` на `.case__media`, `.chip--glass`, `.about__video`
и `.about__dog` — тогда Safari считает эффект один раз, а не переигрывает
рамку видео заново каждый кадр.
